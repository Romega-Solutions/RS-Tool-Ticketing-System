...
-- Apply via Supabase SQL Editor. Mirror of drizzle/0012_lms.sql, kept here
-- because the project pulls Supabase migrations by hand (see [[project_supabase_migrations]]).
-- Phase 1 ships courses + lessons + completions live; the remaining tables
-- exist but are unused until Phases 2 + 3 commits land on this branch.
...
CREATE INDEX IF NOT EXISTS "lms_courses_scope_dept_pub_idx" ON "lms_courses" ("scope", "department", "is_published");
