...
/**
 * The structured detail fields for a position (everything except the rich-text
 * job description). Kept separate from the JD editor so the full-page editor
 * can lay them out in their own column. `defaults` pre-fills for edit mode.
 */
export function PositionDetailFields({ defaults }: { defaults?: PositionDefaults }) {
