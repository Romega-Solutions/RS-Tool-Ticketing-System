...
const WORKFLOWS: WorkflowEntry[] = [
  ...
  },
  {
    ...
    label:   'SOW Follow-up',
    purpose: 'Cron — nudges HRBP when sow_sent_at > 48h ago and sow_signed_at is null.',
    stage:   'offer_signed',
    icon:    FileSignature,
    phase:   'post-mvp',
  },
  ...
  },
  {
    ...
    purpose: 'Sends a survey to the new hire + schedules a 30-day 1:1 with their lead.',
  ...
  },
  {
    ...
    label:   '90-day Review',
    purpose: 'Triggers the regularization-decision form for the lead, sends the outcome letter (PDF) to the new hire.',
