...
import { Bell, AtSign, FolderPlus, CalendarClock, CheckCheck, Timer, MessageSquareReply } from 'lucide-react';
...
function TypeIcon({ type }: { type: string }) {
  ...
  if (type === 'thread_reply') return <MessageSquareReply className={cls} />;
